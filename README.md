...
3. **Vercel**：vercel.com → New Project → Root Directory 填 `public` → Deploy
...
| 模組 | 新增功能 | AI |
|------|---------|-----|
| 飲食 | 情境時間戳（深夜/清晨自動分類）· 碳水循環切換 | Haiku |
| 訓練 | 每個動作記錄實際重量/組數/次數 · 計劃 vs 實際容量對比 | Sonnet |
| 計劃 | 長線週期計劃 · 分階段目標 · 里程碑 · 近期對比歷史 | Sonnet |
